...
/**
 * Implement the custom post types file
 */
require get_stylesheet_directory() . '/lib/custom-post-types.php';

/**
 * Implement the custom taxonomies file
 */
require get_stylesheet_directory() . '/lib/custom-taxonomies.php';
